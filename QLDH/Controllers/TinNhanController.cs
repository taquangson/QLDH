...
namespace QLDH.Controllers
{
    public class TinNhanController : Controller
    {
        ...
        [SessionExpire]
        [HttpPost]
        public ActionResult GuiTinNhan(List<TinNhanModel> data)
        {
            if (data != null)
            {
                ...
                {
                    string json = Push(StringHelper.RemoveVietNameseSign(tn.NoiDungTinNhan), "84" + tn.SoDienThoai.Substring(1));
        ...
        public string Push(string msg, string sodienthoai)
        {
            ...
            try
            {
                ...
                string post = "{\"RQST\": {\"name\": \"send_sms_list\",\"REQID\": \"1\",\"LABELID\": \"133546\",\"CONTRACTID\": \"12596\",\"CONTRACTTYPEID\": \"1\",\"TEMPLATEID\": \"596928\",\"PARAMS\": [{\"NUM\": \"1\","
